...
Systemweit entschieden durch `ECO-ARC-0007-2026-DE` (kueper-ecosystem). Kernaussagen: OTA ist alleinige Source of Truth fuer `DOC:OTA:*`, kueper.com fuer `DOC:KUE:*`. OTA darf `DOC:KUE:*` referenzieren, nie umgekehrt als Quelle. Bei Konflikt gewinnt das kanonische kueper.com-Dokument. OTA stellt stabile `DOC:OTA:*`-IDs fuer KG/SSF bereit (204/212 Dokumente bereits mit graphId). Siehe auch `EXT-ECO-OTA-20260712-001`.
