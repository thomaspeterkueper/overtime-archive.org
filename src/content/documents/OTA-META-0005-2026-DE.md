...
summary: "Arbeitsaudit zur frühen Marsgesellschaft 2040–2069. v0.3 gleicht die autorenseitige NXU-Quelle mit META-0002 v4.5 ab: MIMI 2065 bleibt als Quellenfund prüfbar, `Iteratio Prime Alpha` bleibt verworfene Legacy-Form [D], und ~1.000 Menschen 2067–2069 bleibt ein zu prüfender [P]-Wert."
kg:
  schema: KXF-0.2
...
|---|---|---:|---|
| 2040 | Der Standort des späteren Iterius Prime ist als **Proposed Site Alpha-7** kartiert/bezeichnet. | [K] Werkkanon | OTA-META-0002 |
...
| 2069 | Eine erste Generation auf Mars geborener Kinder existiert; medizinische Infrastruktur reagiert auf das Aufwachsen in 0,38 g. | [K] Werkkanon | OTA-META-0002 |
...
Gesetzt ist nur die Identität des Ortes über die Zeit: `Proposed Site Alpha-7` von 2040 bezeichnet den Standort des späteren Iterius Prime. Nicht gesetzt ist die lückenlose Namens- und Siedlungsfolge.
...
|---|---|---|
| Was ist Alpha-7 2040? | [K] kartierter/bezeichneter Standort | Werkstelle sichern |
...
| Familien/Marsgeburten bis 2069? | [K] grundsätzlich vorhanden | genaue Chronologie offen |
...
1. Werkbelege zu **Proposed Site Alpha-7**, frühen Marskindern und der 1-g-Trainingszentrifuge sichern.
2. Nach einem unabhängigen Werkbeleg für **~1.000 Menschen 2067–2069** suchen.
3. Die in META-0002 benannten Werkstellen zu **Generation Mars, Kap. 1** für Alpha-7, Marskinder und 1-g-Zentrifuge als Primärbelege sichern.
