...
## III. Zwei Stillen — verbindliche Trennung
...
| Feld | Bedeutung |
|---|---|
| `event_truth` | Was geschieht tatsächlich? |
| `public_knowledge` | Was ist zu diesem Zeitpunkt öffentlich? |
| `institutional_knowledge` | Was wissen Organisationen/Fachkreise? |
| `character_knowledge` | Was kann die konkrete Figur plausibel wissen? |
| `source_state` | [K]/[P]/[O]/[C]/[D] |
...
Historischer Alias: `OTA-TIMELINE-ABGLEICH`.
