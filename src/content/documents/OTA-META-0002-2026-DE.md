---
signature: "OTA-META-0002-2026-DE"
title: "OTA-TIMELINE-ABGLEICH — Kanonische Master-Timeline NOXIA"
series: "META"
seriesNumber: 2
year: 2026
language: "DE"
...
kg:
  ...
  documentId: "OTA-META-0002-2026-DE"
  graphId: "DOC:OTA:OTA-META-0002-2026-DE"
  system: SYS:OTA:overtimearchive
  sourceOfTruth: false
---

# THE OVERTIME ARCHIVE
## Meta / Canon Reference Series
...
## II. Master-Timeline — bestätigtes Skelett
...
| **10/2056** | Erste vollständige Mars-Kommunikationsunterbrechung, 72 Stunden | **[K]** | OTA-HIS-0004-2069-DE; setzt bereits bemannte/operative Marsinfrastruktur voraus, deren genaue Größe noch offen ist |
| **2057** | Zunehmende Anomalien und Datenkorruption | **[K]** | OTA-HIS-0004-2069-DE |
...
| **2065** | MIMI wird auf Mars installiert/eingeführt | **[P]** | Jahr aus älterem Masterstand; genaue institutionelle Funktion und Installationsort noch zu belegen |
...
Der Audit trennt harte Werkfixpunkte von älteren Sammelangaben:

| Zeitpunkt | Befund | Status |
|---|---|---:|
| **2040** | `Proposed Site Alpha-7` ist die historische Bezeichnung des späteren Iterius-Prime-Standorts | **[K]** |
| **vor/2056** | bemannte bzw. gesellschaftlich relevante Marsinfrastruktur existiert, da eine 72-stündige vollständige Kommunikationsunterbrechung als Krise geführt wird | **[P]** für Umfang/Bevölkerung |
| **2063** | Mars ist institutionell bedeutend genug für eine eigene AGI-Regelung in der UN Mars Charter | **[K]** |
...
Der derzeitige Quellenbestand reicht **nicht** aus, um ohne neue Autorentscheidung festzulegen:
...
**[P]** `Iterius Prime Alpha` kann als technische Teil-/Landing-Bezeichnung vorkommen; daraus folgt kein alternativer Name der gesamten Siedlung.

### 3.4 Größenordnung 2091
...
## IV. Zwei Stillen — verbindliche Trennung

### Das Schweigen (2067–2069)
...
- Zusammenhang mit Sektor-7 / Monolith ist intern stark, Kausalität bleibt offen.

---

## V. Reconciliation 2087

Die Januar/Februar-Fassung aus OTA-HIS-0003 v3.1 ist aufgrund der expliziten Kanonrevision vom 19.07.2026 verbindlich. Ältere April- und Juni/Juli-Chronologien sind für Datierung/Kausalität **[D]**.

Weiter offen bleiben insbesondere Verhältnis der Sektorbezeichnungen, Rolle Kowalski/Nakahara, 802 m vs. 864 m, Entstehung der Bezeichnung AXIS, Global Array und öffentliche Deklassifizierung.

---

## VI. Wissensstand zur Großen Stille

### Öffentlichkeit 2087

Bekannt sind Kommunikationsausfall, Krise, Zeitraum und veröffentlichte Todes-/Sicherheitsfolgen. Nicht öffentlich bestätigt sind Monolith, AXIS-Kammer, Nakamuras Berührung, der 03:14/03:17-Zusammenhang und eine nichtmenschliche Ursache.

### Fachkreise / klassifizierte Ebene

Fachkreise können begründet erkennen, dass die offizielle Erklärung unvollständig ist. Klassifiziert bekannt sind mindestens Sektor-7-Tief, Monolithkontakt, Signalregistrierung 03:14, Vollausfall 03:17 und interne Frequenz-/Resonanzuntersuchungen. Auch intern bleibt die Kausalität unvollständig geklärt.

---

## VII. Werk- und Figurenregel

> **Weltwissen ist nicht Figurenwissen.**

Für jedes relevante Ereignis werden `event_truth`, `public_knowledge`, `institutional_knowledge`, `character_knowledge` und `source_state` getrennt geführt.

### Beispiel: Frieder Halden

- geb. **12.09.2044**;
- 2055 zehn/elf beim „ausgetauschten Wort“;
...
- 2087 ist er 42;
- kennt zur Großen Stille den öffentlichen Krisenbefund und kann wissenschaftlich begründet zweifeln, besitzt aber nicht automatisch AXIS-/Monolithwissen;
- ältere Angabe „Große Stille 2096 / Frieder 52“ ist **[D]**.

---

## VIII. Aktive Konfliktfelder und aufgelöste Punkte
...
## IX. Post-2091-Auditachsen

Bereits festgestellte, noch nicht vollständig reconciliierte Zeiträume:

| Zeitraum | Werk-/OTA-Befund | Status |
|---|---|---:|
| **2091** | SSEP-/Generation-Mars-Komplex; Piazzi-Lights/Ceres, Luna, L5 und Mars aktiv verbunden | **[K/P]** |
| **2095/96** | OTA-Dokumente vorhanden | **[P]** |
| **2098** | Korolev Station Alpha / noχ¹ᐃ-Strang | **[P]** |
| **2120–2125** | Bor-/Industriekrisen-Strang | **[P]** |
| **2142 / 2147** | eigene OTA-Dokumentgruppen | **[P]** |
| **2150–2156** | Resonanz-/Kalgaii-/K'ragoss-nahe Schichten | **[P]** |
| **2160–2164 / 2171 / 2188** | weitere OTA-Dokumentgruppen | **[P]** |
| **2195/96** | Archiv-/Deklassifizierungs- und Zukunftsdokumente | **[P]** |
| **2472** | *Die Horcher* / Soma Retep, Uranus XXIX „Silence“ | **[P]** |

Nächste Einzelabgleiche: frühe Marsbesiedlung, MIMI, SSEP/Ceres/Piazzi-Lights, 2095/96, Korolev 2098, Bor 2120–2125, K'ragoss/Lain Thorn/Zereya, *Die Kinder von Ceres*, Soma Retep/*Die Horcher*.

---

## X. Revisionsregeln

1. Explizite spätere Autor-/Kanonrevisionen haben Vorrang.
2. Ein Dokument kann insgesamt aktiv sein und einzelne veraltete Angaben enthalten.
3. Widersprüche werden nicht stillschweigend geglättet.
4. Öffentlicher Wissensstand und tatsächliches Ereignis werden getrennt geführt.
5. Romanmanuskripte sind für Werkereignisse Primärquellen.
6. META-0002 ist Referenz und Konfliktregister, nicht automatische Source of Truth für jedes Detail.
7. Aufgelöste Konflikte sollen anschließend in widersprechenden Quelldokumenten korrigiert oder als historische Fassung markiert werden.

---

## XI. Provenienz und Revisionsverlauf

Ausgangsdokument: `OTA-TIMELINE-ABGLEICH-v2`, ursprünglich in `noxia-universe/canon/timeline/`, Stand Juni 2026.  
Übernahme in OTA: 19. Juli 2026.  
Grundlegender Kanon-Audit: 8. September 2026.  
Kanonische OTA-ID: `DOC:OTA:OTA-META-0002-2026-DE`.

| Datum | Version | Änderung |
|---|---|---|
| Juni 2026 | v2 | NXU-Masterabgleich; frühe Entwicklungsstände |
| 2026-07-19 | v3.0 | Übernahme ins OTA; Januar-Fassung der Großen Stille als Masterstand |
...
**Signatur:** OTA-META-0002-2026-DE  
**Alias:** OTA-TIMELINE-ABGLEICH